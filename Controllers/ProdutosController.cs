...
namespace TrabalhoFinalCsharp.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,QuantidadeEstoque,NomeProduto,ValorUnidade,Slug")] ProdutoModel produtoModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,QuantidadeEstoque,NomeProduto,ValorUnidade,Slug")] ProdutoModel produtoModel)
        {
